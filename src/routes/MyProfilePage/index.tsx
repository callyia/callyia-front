...
export default function MyProfilePage() {
  ...
  const handleProfileImageChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      axios
        .post("http://localhost:8080/Callyia/s3/profile", formData, {
          headers: {
      ...
      >
        ...
        >
          <img
            ...
            className={`my-profile-picture ${
              isEditing ? "my-profile-picture-hover" : ""
            }`}
        ...
        >
          ...
          <div
            ...
            onClick={() => navigate(`/MyInformationPage`)}
          >
            {userInfo?.nickname}
          </div>
          ...
          <div className="profile-actions">
            <div className="profile-action-div">
              <button
                ...
                onClick={() => changeContent("ScheduleContent")}
              >
                <img
                  src="./profile/profile_calender_icon.png"
                  alt="my calender"
                />
              </button>
              <h3>나의 일정 바로가기</h3>
            ...
            <div className="profile-action-div">
              <button
                className="profile-action-button"
                onClick={() => changeContent("CartContent")}
              >
                <img
                  src="./profile/profile_shop_bag_basket_icon.png"
                  alt="my scuedule cart"
                />
              </button>
              <h3>나의 일정 장바구니</h3>
            </div>
            <div className="profile-action-div">
              <button
                className="profile-action-button-post"
                onClick={() => changeContent("PlanContent")}
              >
                <img
                  src="./profile/profile_post_icon.png"
                  alt="schedule being edited"
                />
              </button>
              <h3>편집 중인 일정</h3>
            </div>
